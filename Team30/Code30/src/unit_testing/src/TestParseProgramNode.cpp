...
tokens.
push_back(std::static_pointer_cast<Token>(std::make_shared<WordToken>("not_procedure"))
);
tokens.
...
parseProgram(), std::invalid_argument
...
tokens.
push_back(std::static_pointer_cast<Token>(std::make_shared<WordToken>("procedure"))
);
tokens.
push_back(std::static_pointer_cast<Token>(std::make_shared<WordToken>("main"))
);
...
tokens.
push_back(std::static_pointer_cast<Token>(std::make_shared<WordToken>("proc"))
);
tokens.
push_back(std::static_pointer_cast<Token>(std::make_shared<SpecialCharToken>("{"))
);
