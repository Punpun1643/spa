...
TEST_CASE("Test WithClause") {
  ...
  AttrRef attr_ref_proc =
      AttrRef(PqlDeclaration("proc", EntityType::PROCEDURE));
  ...
  AttrRef attr_ref_read_alias =
      AttrRef(PqlDeclaration("read", EntityType::READ), AttrType::VAR_NAME);
  AttrRef attr_ref_read = AttrRef(PqlDeclaration("read", EntityType::READ));
  AttrRef attr_ref_call_alias =
      AttrRef(PqlDeclaration("call", EntityType::CALL), AttrType::PROC_NAME);
  ...
  SECTION("Incompatible args should throw semantic error") {
    ...
    REQUIRE_THROWS_AS(WithClause(attr_ref_stmt, "wwdwdw"),
                      InvalidSemanticsException);
    REQUIRE_THROWS_AS(WithClause("abc", attr_ref_const),
                      InvalidSemanticsException);

    REQUIRE_THROWS_AS(WithClause(attr_ref_stmt, attr_ref_read_alias),
                      InvalidSemanticsException);
    REQUIRE_THROWS_AS(WithClause(attr_ref_call_alias, attr_ref_const),
                      InvalidSemanticsException);
