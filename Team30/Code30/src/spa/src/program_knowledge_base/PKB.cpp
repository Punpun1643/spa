...
std::string convertEntityAttribute(std::string value, EntityType type, AttrType curr_attr_type, AttrType wanted_attr_type) {
    return "";
};

bool doesEntityExist(EntityType type, AttrType attr_type, std::string value) {
    return false;
};
