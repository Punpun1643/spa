...
std::unordered_map<EntityType, AttrType> const EntityAttrPairings::DEFAULT_ATTR_TYPE = {
...
std::unordered_map<EntityType, AttrType> const EntityAttrPairings::ATTR_TYPE_ALIASES = {
    {EntityType::CALL, AttrType::PROC_NAME},
    {EntityType::READ, AttrType::VAR_NAME},
    {EntityType::PRINT, AttrType::VAR_NAME}};

bool EntityAttrPairings::IsDefaultPair(EntityType ent_type, AttrType attr_type) {
