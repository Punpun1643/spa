...
std::unique_ptr<ClauseResult> ModifiesPClause::evaluateWildDeclaration(
    PkbApi& pkb) {
  throw InvalidSemanticsException(
      "1st argument of Modifies cannot be a wildcard");
}

std::unique_ptr<ClauseResult> ModifiesPClause::evaluateWildWild(PkbApi& pkb) {
  throw InvalidSemanticsException(
      "1st argument of Modifies cannot be a wildcard");
}

std::unique_ptr<ClauseResult> ModifiesPClause::evaluateWildValue(PkbApi& pkb) {
  throw InvalidSemanticsException(
      "1st argument of Modifies cannot be a wildcard");
}
