...
class UsesPClause : public SuchThatClause {
 private:
  ...
  std::string INVALID_ARG_1_ENTITY_TYPE_MSG =
      "The 1st declaration arg of UsesP must be a procedure synonym or name.";
  std::string INVALID_ARG_2_ENTITY_TYPE_MSG =
      "If the 2nd arg of UsesP is a declaration, it must have the var type.";
  std::string INVALID_ARG_1_REF_TYPE_MSG =
      "1st argument of UsesP cannot be a wildcard";
