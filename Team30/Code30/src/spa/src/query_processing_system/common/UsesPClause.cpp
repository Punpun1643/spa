...
UsesPClause::UsesPClause(std::unique_ptr<EntRef> arg1,
    ...
    : SuchThatClause(std::move(arg1), std::move(arg2), RelationType::USES_P) {
...
std::unique_ptr<ClauseResult> UsesPClause::evaluateWildDeclaration(
    PkbApi& pkb) {
  throw InvalidSemanticsException("1st argument of Uses cannot be a wildcard");
}

std::unique_ptr<ClauseResult> UsesPClause::evaluateWildWild(PkbApi& pkb) {
  throw InvalidSemanticsException("1st argument of Uses cannot be a wildcard");
}

std::unique_ptr<ClauseResult> UsesPClause::evaluateWildValue(PkbApi& pkb) {
  throw InvalidSemanticsException("1st argument of Uses cannot be a wildcard");
}
