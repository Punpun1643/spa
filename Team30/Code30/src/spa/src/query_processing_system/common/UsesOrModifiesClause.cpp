...
UsesOrModifiesClause::UsesOrModifiesClause(std::unique_ptr<const PqlReference> arg1,
...
std::unique_ptr<ClauseResult> UsesOrModifiesClause::evaluateWildDeclaration(
    PkbApi& pkb) {
  throw InvalidSemanticsException("1st argument of Uses/Modifies cannot be a wildcard");
}

std::unique_ptr<ClauseResult> UsesOrModifiesClause::evaluateWildWild(PkbApi& pkb) {
  throw InvalidSemanticsException("1st argument of Uses/Modifies cannot be a wildcard");
}

std::unique_ptr<ClauseResult> UsesOrModifiesClause::evaluateWildValue(PkbApi& pkb) {
  throw InvalidSemanticsException("1st argument of Uses/Modifies cannot be a wildcard");
}
