...
SuchThatListExpression::GetSuchThatExpressions() {
  return std::make_unique<std::vector<std::shared_ptr<SuchThatExpression>>>(
      this->such_that_list);
}

void SuchThatListExpression::acceptInterpreter(QueryInterpreter& interpreter) {
